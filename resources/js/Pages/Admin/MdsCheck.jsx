...
var numrows = 10;
const mds_check_booklet = []
for (let i = 1; i <= numrows; i++) {
    mds_check_booklet.push(i);
}

export default function MdsCheck({auth, pending}) {
    ...
    <div className="py-32">
        ...
        <Modal show={isOpen} maxWidth={'3xl'} >
                        ...
                        <div class="flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                            <h5 class="text-xl font-medium leading-normal text-gray-800" id="exampleModalScrollableLabel">Request for Re-Order of MDS Check</h5>
                            ...
                            <form onSubmit={submit} className="mt-6 space-y-6">
                                <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                                    <div className="max-w-2xl">
                                        ...
                                        <ul class="max-w-xl space-y-5 text-gray-500 list-disc list-inside dark:text-gray-400">
                                            <li>
                                               Use this form when requesting for Re-order of MDS Check Booklets in Region V
                                            </li>
                                            <li>
                                                To ensure prompt processing, please provide <span class="font-medium text-black">ALL</span> information requested below. 
                                            </li>
                                            <li>
                                                Request for Re-Order  <span class="font-medium text-black"> CANNOT</span> be processed if there is/are pending supporting documents/reports necessary in the approval of request.
                                            </li>
                                            ...
                                            <span class="font-medium text-black">Mandatory Supporting Documents </span>are as follows: 
                                                <ul className='ps-5 mt-2 space-y-1 list-decimal list-inside'>
                                                    <li>Letter Request (Form 1)
                                                        <p className='indent-2'> Note: See attached TC 4-2022 for the revised format: http://bit.ly/3H3CTiq</p>
                                                    </li>
                                                    <li>Monthly Estimate of Inventory/AP that cannot be paid thru ADA (Form 2)</li>
                                                    <li> Report of Accountability for Accountable Forms (RAAFs) for MDS (Latest 3 months)</li>
                                                </ul>
                                            </li>
                                        </ul>
                                         <br />
                                        <p>Note: Kindly merge all the requirements in <span class="font-medium text-black">one single pdf file</span>. </p>
                                        <br />
                                ...
                                <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                                    <div className="max-w-xl">
                                        ...
                                        <div class="mb-2">
                                            <InputLabel htmlFor="agency_name" value="Name of Agency Head" />
                                            <input type="text" id="agency_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(First Name, M.I ,Last Name)" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="designation_position" value="Designation/Position (Agency Head)" />
                                            <input type="text" id="designation_position" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(Spell in Full)" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="office_address" value="Office Address" />
                                            <input type="text" id="office_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="account_number_requested" value="Account Numer Requested" />
                                            <input type="text" id="account_number_requested" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="account_name" value="Account Name" />
                                            <input type="text" id="account_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(Spell in Full)" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="bank_branch" value="Bank Branch" />
                                            <input type="text" id="bank_branch" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(Spell in Full e.g. Land Bank of the Philippines- Legazpi Branch)" required />
                                            <InputError className="mt-2" message="" />
                                        </div>

                                        <div class="mb-2">
                                            <InputLabel htmlFor="bank_branch" value="No. of Requested MDS Check Booklet" />
                                            <SelectInput
                                                    name="province"
                                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    options={mds_check_booklet}
                                                />
                                            <InputError className="mt-2" message="" />
                                        </div>
